...
const ar: Record<DictKey, string> = {
  ...
  'programs.intro':
    'من اللمسات الأولى في فئة تحت 6 سنوات حتى اللعب التنافسي في فئة تحت 16 سنة — ستة فرق، ورحلة واحدة واضحة. تتدرب كل فئة أيام الأحد والثلاثاء والأربعاء، وتختار حصتين أو 3 حصص أسبوعيًا.',
  ...
  'calendar.intro':
    'تتدرب كل فئة عمرية أيام الأحد والثلاثاء والأربعاء، وتحتفظ بالموعد نفسه طوال الفصل الدراسي. وتختلف مواعيد الشتاء عن الصيف — ويوضح الجدول أدناه كليهما.',
  ...
  'meta.calendarDesc':
    'تقويم التدريبات والجدول الأسبوعي لكل فئة عمرية في أكاديمية جنوى عُمان — من تحت 6 إلى تحت 16 سنة، أيام الأحد والثلاثاء والأربعاء، بمواعيد الشتاء والصيف.',
  'meta.joinDesc':
